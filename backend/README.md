...
1. **processing.py**: Handles Excel file validation and processing, generating CSV files with standardized data
...
├── processing.py                 # Excel validation and processing
├── core-algorithm.py              # Timetable generation algorithm
